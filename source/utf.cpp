...
psize garden::utf32toUtf8(u32string_view utf32, string& utf8)
{
	if (utf32.empty())
	{
		utf8.resize(0);
...
psize garden::validateUTF8(string_view utf8)
{
...
//**********************************************************************************************************************
psize garden::utf8toUtf32(string_view utf8, u32string& utf32)
{
	if (utf8.empty())
	{
		utf32.resize(0);
...
psize garden::validateUTF32(u32string_view utf32)
{

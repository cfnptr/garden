...
//**********************************************************************************************************************
CutoutModelSystem::CutoutModelSystem(bool setSingleton) : 
	ModelCompAnimSystem("model/cutout"), Singleton(setSingleton)
{
	Manager::getInstance()->addGroupSystem<IMeshRenderSystem>(this);
}

string_view CutoutModelSystem::getComponentName() const
{
	return "Cutout Model";
}

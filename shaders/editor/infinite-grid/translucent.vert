...
void main()
{
	...
	fs.nearPoint = calcWorldPosition(1.0f, texCoords, cc.invViewProj) + cc.cameraPos;
	fs.farPoint = calcWorldPosition(0.0001f, texCoords, cc.invViewProj) + cc.cameraPos; // 0.001 is for inf far plane

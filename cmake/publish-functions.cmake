...
macro(collectPackEqui2cubes PACK_CACHES_DIR PACK_RESOURCES_DIR
	...
	foreach(EQUI2CUBE ${PACK_EQUI2CUBE_PATHS})
		...
		list(APPEND ${PACK_RESOURCES} "${${PACK_CACHES_DIR}}/${EQUI2CUBE_PATH}-nx.hdr")
		list(APPEND ${PACK_RESOURCES} "${EQUI2CUBE_PATH}-nx.hdr")
		list(APPEND ${PACK_RESOURCES} "${${PACK_CACHES_DIR}}/${EQUI2CUBE_PATH}-px.hdr")
		list(APPEND ${PACK_RESOURCES} "${EQUI2CUBE_PATH}-px.hdr")
		list(APPEND ${PACK_RESOURCES} "${${PACK_CACHES_DIR}}/${EQUI2CUBE_PATH}-ny.hdr")
		list(APPEND ${PACK_RESOURCES} "${EQUI2CUBE_PATH}-ny.hdr")
		list(APPEND ${PACK_RESOURCES} "${${PACK_CACHES_DIR}}/${EQUI2CUBE_PATH}-py.hdr")
		list(APPEND ${PACK_RESOURCES} "${EQUI2CUBE_PATH}-py.hdr")
		list(APPEND ${PACK_RESOURCES} "${${PACK_CACHES_DIR}}/${EQUI2CUBE_PATH}-nz.hdr")
		list(APPEND ${PACK_RESOURCES} "${EQUI2CUBE_PATH}-nz.hdr")
		list(APPEND ${PACK_RESOURCES} "${${PACK_CACHES_DIR}}/${EQUI2CUBE_PATH}-pz.hdr")
		list(APPEND ${PACK_RESOURCES} "${EQUI2CUBE_PATH}-pz.hdr")
	endforeach()
endmacro()
...
function(packResources PACK_EXE_NAME PACK_CACHES_DIR PACK_APP_RES_DIR
	...
	collectPackShaders(PACK_CACHES_DIR PACK_GARDEN_RES_DIR INCLUDE_EDITOR
		INCLUDE_DEBUG PACK_GARDEN_SHADERS PACK_APP_RES_PATHS)
	collectPackShaders(PACK_CACHES_DIR PACK_APP_RES_DIR INCLUDE_EDITOR
		INCLUDE_DEBUG PACK_APP_SHADERS PACK_APP_RES_PATHS)

	set(PACK_GARDEN_EQUI2CUBES)
	set(PACK_APP_EQUI2CUBES)

	collectPackEqui2cubes(PACK_CACHES_DIR PACK_GARDEN_RES_DIR INCLUDE_EDITOR
		INCLUDE_DEBUG PACK_GARDEN_EQUI2CUBES PACK_APP_RES_PATHS)
	collectPackEqui2cubes(PACK_CACHES_DIR PACK_APP_RES_DIR INCLUDE_EDITOR

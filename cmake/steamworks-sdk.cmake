...
if(NOT DEFINED STEAMWORKS_SDK_DIR)
	set(STEAMWORKS_SDK_DIR libraries/steamworks-sdk)
endif()

if(NOT EXISTS ${PROJECT_SOURCE_DIR}/${STEAMWORKS_SDK_DIR})
	message(FATAL_ERROR "Steamworks SDK directory does not exist! Please download SDK.")
endif()

set(STEAMWORKS_SDK_INCLUDE_DIR ${STEAMWORKS_SDK_DIR}/public)
set(STEAMWORKS_SDK_BIN_DIR ${STEAMWORKS_SDK_DIR}/redistributable_bin)

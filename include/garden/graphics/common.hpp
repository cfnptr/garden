...
enum class ShaderStage : uint32
{
	...
	RayGeneration = 0x08, /**< Creates and launches rays into the scene. */
	Intersection  = 0x10, /**< Handles ray intersection with custom geometry. */
	AnyHit        = 0x20, /**< Invoked for every potential hit along a ray. */
	ClosestHit    = 0x40, /**< Executed on a geometry hit, closes along the ray. */
	Miss          = 0x80  /**< Handles rays that don't hit anything in the scene. */
};
